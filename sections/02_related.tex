...
differ on each axis that defines our question: we benchmark hosted black-box APIs
rather than an open-weight model, across three procedures rather than one, with
...
three procedures but generate generic faces rather than editing a patient's photo.
