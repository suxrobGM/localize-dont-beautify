...
inpainting model, two requested edit types, and publicly accessible
...
\begin{itemize}
  ...
  black-box APIs: prompt-only, a client-side masked composite that cuts
  ...
  the one tested mask-specific model does not outperform compositing. A
...
manipulated variable. When the editor is a black-box API, no
