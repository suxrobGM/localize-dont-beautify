...
photographs serve only as identity references. Within that scope, region
confinement for surgical previews requires no model access and can be enforced
uniformly, and cheaply, on the client.
