...
\textbf{No cherry-picking.} Every experiment runs its full face--model--procedure
--control matrix under a fixed seed into an immutable, git-stamped run directory,
